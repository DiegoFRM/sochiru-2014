...
import { nextYear, timeLeft } from "../utils/utils.js";
...
function TimerSection() {
  ...
  const timeId = useRef();
  const [videoScreen,setVideoScreen] = useState("https://www.youtube.com/embed/ygluZ0tB8S4?si=saeeLYfrKYlUz2Bw")
  ...
  return (
    <>
      ...
      <section className="video-buttons mt-10">
        <div className="col-12 text-center title-buttons-section p-5 ">
          ...
          <div className="container">
            <div className="grid md:grid-cols-4 grid-cols-2 gap-1 px-6 m-2 text-buttons">
              {objectsButtons.map((object, i) =>
                object.hasImg ? (
                  <div
                    className="text-center grig-3 justify-self-center"
                    key={i}
                    onClick={()=>setVideoScreen(object.video)}
                  >
